...
static int	ft_fetch_precision_dot(t_ftprintf arg_data, const char *fmt, int i)
{
	int	precision;
...
int	ft_fetch_arg_data(t_ftprintf arg_data, const char *fmt, int i)
{
	...
	i = ft_fetch_precision_dot(arg_data, fmt, i);
	i = ft_fetch_precis_astrsk(arg_data, fmt, i);
